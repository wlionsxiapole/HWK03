...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2x = ObjectAnimator.ofFloat(target, "scaleX", 1.0f, 2.0f, 1.0f);
        ...
        ObjectAnimator animator2y = ObjectAnimator.ofFloat(target, "scaleY", 1.0f, 2.0f, 1.0f);
